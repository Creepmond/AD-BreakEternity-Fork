...
export const chall = {
  ...
  ec9: "You cannot buy Tickspeed upgrades. Infinity Power instead multipliers Time Dimensions with greatly reduced effect. $",
  ec9rew: "Infinity Dimension multiplier based on Time Shards",
  ec10: "Time Dimensions and Infinity Dimensions are disabled. You gain an immense boost from Infinities to Antimatter Dimensions (Infinities^$1aX). $",
  ec10rew: "Time Dimension multiplier based on Infinities",
  ec10rewFormat: "$1aX (After TS31: $2aX)",
  ec11: "All Dimension multipliers and powers are disabled, except for the multipliers from Infinity Dimensions and Dimension Boosts (to Antimatter Dimensions). $",
  ...
  ec12real: "The game runs ×$1aX slower; all other game speed effects are disabled. The goal must be reached within a certain amount of time or you will fail the challenge. $",
