...
export const pelleQuotes = {
  ...
  galaxyGeneratorUnlock: {
    id: 7,
    get lines() {
      return i18nquote(["pelle7q0", "pelle7q1", "pelle7q2", "pelle7q3", "pelle7q4", "pelle7q5"], ["", filament, cluster, "", "", mandate]);
    },
  },
  galaxyGeneratorRifts: {
    id: 8,
    get lines() {
      return i18nquote(["pelle8q0", "pelle8q1", "pelle8q2", "pelle8q3", "pelle8q4", "pelle8q5"], [destroyer, filament, inevitable, "", inevitable, unbroken]);
    },
  },
  galaxyGeneratorPhase1: {
    id: 9,
    get lines() {
      return i18nquote(["pelle9q0", "pelle9q1"], ["", inevitable]);
    },
  },
  galaxyGeneratorPhase4: {
    id: 10,
    get lines() {
      return i18nquote(["pelle10q0"]);
    },
  },
  end: {
    id: 11,
